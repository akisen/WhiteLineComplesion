        ...
        for output in outputs:
            if len(output.shape) == 4 and output.shape[3] == 3:
                ...
                for i, image in enumerate(output):
                    ...
                    logger.info('./out/epoch{}_{}.png is saved'.format(epoch, i), image)
...
#print("\n\n\n\ntestimage_path:"+ args.testimage_path)
...
fit = model.fit_generator(train_data_generator,
